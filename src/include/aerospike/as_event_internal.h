...
/******************************************************************************
 * SWOOLE INLINE FUNCTIONS
 *****************************************************************************/
#elif defined(AS_USE_SWOOLE)
    int as_event_validate_connection(as_event_connection* conn);
    void as_event_stop_timer(as_event_command* cmd);
    void as_event_stop_watcher(as_event_command* cmd, as_event_connection* conn);
    void as_event_command_release(as_event_command* cmd);
